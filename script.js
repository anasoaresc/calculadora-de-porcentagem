...
function calcular(event) {
    ...
    switch (btnId) {
        ...
        case 'btn2':
            ...
            document.getElementById('res2').value = calculo2.toFixed(3) + '%';
        break
        ...
        case 'btn3':
            ...
            document.getElementById('res3').value = calculo3.toFixed(3) + '%';
        break
        ...
        case 'btn4':
            ...
            document.getElementById('res4').value = calculo4.toFixed(3) + '%';
        break
        ...
        case 'btn5':
            ...
            document.getElementById('res5').value = calculo5.toFixed(3) + '%';
        break
